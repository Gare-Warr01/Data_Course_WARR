...
LETTERS # works both in capalized and lowercase
class(letters) #this is a vector 
letters[5]
...
vector2 / 2
vector1*vector2
vector1 * c(1, 2) #this is a multiple recycle isuse, make sure the intergers are the same 
vector1 + 6 # 6 or any number is a vector
...
!(vector1 %in% 1:6) #this ! flips the statment 
...
class(dat$Petal.Length) #this is numbers 
class(dat$Species) #this is factor 
...
as.character(vector1) #changed the vector to character
